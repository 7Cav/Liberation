...
FOB_truck_typename = "rhsusf_m1152_sicps_usarmy_wd";                    // This is the FOB as a vehicle.
...
light_vehicles = [
    ...
    ["rhsusf_m1025_w",50,0,50],                                        // M1025A2
    ["rhsusf_m1025_w_m2",50,25,50],                                    // M1025A2 (M2)
    ["rhsusf_m1025_w_mk19",100,50,50],                                  // M1025A2 (Mk19)
    ["rhsusf_m998_w_2dr_fulltop",50,0,50],                             // M1097A2 (2D)
    ["rhsusf_m998_w_2dr_halftop",50,0,50],                             // M1097A2 (2D / open back)
    ...
    ["rhsusf_m1240a1_m2_uik_usarmy_wd"],140,40,60],                     // M1240A (M2)
    ["rhsusf_m1240a1_mk19_uik_usarmy_wd"140,60,60],                     // M1240A (Mk19)
...
heavy_vehicles = [
    ...
    ["rhsusf_stryker_m1134_wd",200,200,100],                            // M1134 Stryker (ATGM)
...
air_vehicles = [
    ...
    ["rhs_uh1h_hidf_gunship",230,200,125],                              // UH-1H (Vietnam Huey)
    ...
    ["FIR_A10A",1000,1000,400],                                         // A-10A Firewill
    ["FIR_A10C",1250,1250,400],                                         // A-10C Firewill
    ["FIR_A10U_Blank2",2000,1800,500],                                  // A-10U Firewill (unmanned)
    ["RHSGREF_A29B_HIDF",750,850,400],                                  // Super Tucano A-29
...
support_vehicles = [
    ...
    ["Box_NATO_AmmoVeh_F",50,100,0],                                    // Vehicle Ammo Box (Vanilla)
    ["ACE_Box_82mm_Mo_HE",50,20,0],
...
elite_vehicles = [
    ...
    "FIR_A10A",                                                         // A-10A (Firewill CAS)
    "FIR_A10C",                                                         // A-10C (Firewill CAS)
    ...
    "FIR_A10U_Blank2",                                                  // A-10U (firewill Unmanned A10U)
