// 7CAV custom variant for Opposing forces
...
militia_squad = [
    ...
    "rhs_mvd_izlom_rifleman",                                           // Rifleman Guard
    "rhs_mvd_izlom_rifleman_LAT",                                       // Rifleman (AT)
    "rhs_mvd_izlom_sergeant",                                           // Sergeant TL
    "rhs_vmf_emr_medic",                                                // VMF Medic
    "rhs_vmf_emr_rifleman",                                             // VMF Rifleman
    "rhs_vmf_emr_at",                                                   // VMF Rifleman (AT)
    "rhs_vmf_emr_arifleman_rpk"                                         // VMF Autorifleman
];
...
opfor_vehicles_low_intensity = [
    "rhs_tigr_sts_msv",                                                 // GAZ-233014 (Armed)
    "rhs_tigr_sts_msv",                                                 // GAZ-233014 (Armed)
    "rhsgref_BRDM2_msv",                                                // BRDM-2 (Armed)
...
opfor_battlegroup_vehicles = [
    ...
    "rhs_bmp2d_msv",                                                    // BMP-2D
    "rhs_bmp2k_msv",                                                    // BMP-2K
    "rhs_bmp3m_msv",                                                    // BMP-3 M
    "rhs_brm1k_msv",                                                    // BRM-1K
    "rhs_btr80_vmf",                                                    // BTR-80
    "rhs_zsu234_aa",                                                    // ZSU-23-4V
    "rhs_zsu234_aa",                                                    // ZSU-23-4V
    "rhs_t80",                                                          // T80
    "rhs_t80",                                                          // T80
...
opfor_troup_transports = [
    ...
    "RHS_Mi24P_AT_vvsc",                                                // Mi-24P (AT)
    "RHS_Mi24V_AT_vvsc",                                                // Mi-24V (AT)
    "rhs_kraz255b1_cargo_open_msv",                                     // Kraz 255B1 (Open)
    "rhs_zil131_msv",                                                   // Zil Transport (Covered)
    "rhs_gaz66_msv"                                                     // GAZ Transport (Covered)
];
