...
KP_liberation_convoy_ambush_chance = 25;                                 // Chance that a logistic convoy will be ambushed, when civil reputation is low.
