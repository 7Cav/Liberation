...
switch (_msgType) do {
    ...
    case 6: {systemChat (format [localize "STR_CR_EPWMSG", (_data select 0)]);};
    case 7: {systemChat (format [localize "STR_CR_TKMSG", (_data select 0), (_data select 1)]);};
    case 8: {systemChat (format [localize "STR_CR_CIVVEH_MSG", (_data select 0)]);};
