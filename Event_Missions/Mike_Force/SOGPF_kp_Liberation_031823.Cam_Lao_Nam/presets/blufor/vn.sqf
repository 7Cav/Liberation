...
light_vehicles = [
    ...
    ["vn_b_boat_12_02",200,120,75],                                     // PBR MKII (M60)
    ["vn_b_boat_13_01",200,120,75]                                      // PBR MKII (MK18)
];

heavy_vehicles = [
    ["vn_b_armor_m113_acav_05", 150, 100, 100],                         // M113A1 (MK18)
    ["vn_b_armor_m113_acav_04", 150, 100, 100],                         // M113A1 (M134)
    ["vn_b_armor_m113_acav_02", 150, 100, 100],                         // M113A1 (M1919)
    ["vn_b_armor_m113_acav_01", 150, 100, 100],                         // M113A1 (M2)
    ["vn_b_armor_m113_acav_06", 150, 100, 100],                         // M113A1 (M2/M240)
    ["vn_b_armor_m113_01", 150, 100, 100],                              // M113A1 TRANSPORT (M2)
    ["vn_b_armor_m113_acav_03", 150, 100, 100],                         // M113A1 (M60)
...
air_vehicles = [
    ...
    ["vn_b_air_f100d_cap",1500,1750,450],                               // F100D (CAP)
    ["vn_b_air_f100d_cas",1500,1750,450]                                // F100D (CAS)
];
