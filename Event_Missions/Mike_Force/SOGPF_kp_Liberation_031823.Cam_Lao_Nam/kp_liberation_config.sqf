...
1  = Vietnam Era - MACV - Military Assistance Command, Vietnam */
KP_liberation_preset_blufor = 1;

/* OPFOR preset:
0  = Custom (default vanilla CSAT)
1  = Vietnam Era - PAVN - People's Army of Vietnam */
KP_liberation_preset_opfor = 1;

/* Resistance preset:
0  = Custom (default vanilla FIA)
1  = Vietnam Era - ARVN - Army of the Republic Vietnam */
...
KP_liberation_cr_kill_penalty = 8;                                      // Civil Reputation penalty for killing a civilian.
